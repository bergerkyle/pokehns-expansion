...
const struct NatureInfo gNaturesInfo[NUM_NATURES] =
{
    [NATURE_HARDY] =
    {
        ...
        .natureGirlMessage = BattleFrontier_Lounge5_Text_NatureGirlHardyDocileNaiveQuietQuirky,
...
// HnS TODO?
/*enum NationalDexOrder NationalToRegionalOrder(enum NationalDexOrder nationalNum)
{
    if (IS_FRLG)
