...
#define I_KEY_ESCAPE_ROPE               GEN_3       // GEN_LATEST  // In Gen8, Escape Rope became a Key Item. Keep in mind, this will make it free to buy in marts.
...
#define I_SELL_VALUE_FRACTION           GEN_3       // GEN_LATEST  // In Gen9+, items sell for 1/4 of their value instead of 1/2.
#define I_PRICE                         GEN_3       // GEN_LATEST  // Some items have varied in value across generations.
#define I_BERRY_PRICE                   GEN_3       // GEN_7       // Since Berries have become unplantable (Gen8+), their price has gone up.
